...
/*   Updated: 2023/07/20 19:30:12 by fahmadia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_texture	create_all_textures(void)
{
	...
	textures.pl = mlx_load_png("images/player_down.png");
	...
	textures.enemy = mlx_load_png("images/enemy_down.png");
	return (textures);
}
...
t_image	create_all_images(t_game *game)
{
	...
	images.enemy = mlx_texture_to_image(game->window, game->textures.enemy);
	return (images);
}
